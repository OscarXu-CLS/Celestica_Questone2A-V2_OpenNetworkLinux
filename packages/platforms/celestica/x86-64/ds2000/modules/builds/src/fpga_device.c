/*
 * fpga_device.c - PCI device driver for Silverstone Switch board FPGA.
 *
...
MODULE_AUTHOR("Nicholas Wu<nicwu@celestica.com>/Oscar Xu <ohsu@celestica.com>");
MODULE_DESCRIPTION("Celestica DS2000 FPGA driver");
