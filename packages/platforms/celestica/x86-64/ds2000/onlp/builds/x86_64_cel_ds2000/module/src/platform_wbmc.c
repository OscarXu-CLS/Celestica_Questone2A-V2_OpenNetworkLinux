...
int get_psu_info_wbmc(int id, int *mvin, int *mvout, int *mpin, int *mpout, int *miin, int *miout)
{
    ...
    /*
		...
		PSU1_VIn		 | 221.100	  | Volts	   | ok    | na 	   | na 	   | na 	   | na 	   | na 	   | na
		PSU1_CIn		 | 0.320	  | Amps	   | ok    | na 	   | na 	   | na 	   | na 	   | na 	   | na
		PSU1_PIn		 | 60.000	  | Watts	   | ok    | na 	   | na 	   | na 	   | na 	   | na 	   | na
		PSU1_Fan		 | 4000.000   | RPM 	   | ok    | na 	   | na 	   | na 	   | na 	   | na 	   | na
		PSU1_Temp1		 | 30.000	  | degrees C  | ok    | na 	   | na 	   | na 	   | na 	   | na 	   | na
		PSU1_Temp2		 | 27.000	  | degrees C  | ok    | na 	   | na 	   | na 	   | na 	   | na 	   | na
		PSU1_VOut		 | 12.100	  | Volts	   | ok    | na 	   | na 	   | na 	   | na 	   | na 	   | na
		PSU1_COut		 | 4.000	  | Amps	   | ok    | na 	   | na 	   | na 	   | na 	   | na 	   | na
		PSU1_POut		 | 48.000	  | Watts	   | ok    | na 	   | na 	   | na 	   | na 	   | na 	   | na
		PSU2_VIn		 | 220.000	  | Volts	   | ok    | na 	   | na 	   | na 	   | na 	   | na 	   | na
		PSU2_CIn		 | 0.240	  | Amps	   | ok    | na 	   | na 	   | na 	   | na 	   | na 	   | na
		PSU2_PIn		 | 48.000	  | Watts	   | ok    | na 	   | na 	   | na 	   | na 	   | na 	   | na
		PSU2_Fan		 | 3600.000   | RPM 	   | ok    | na 	   | na 	   | na 	   | na 	   | na 	   | na
		PSU2_Temp1		 | 27.000	  | degrees C  | ok    | na 	   | na 	   | na 	   | na 	   | na 	   | na
		PSU2_Temp2		 | 25.000	  | degrees C  | ok    | na 	   | na 	   | na 	   | na 	   | na 	   | na
		PSU2_VOut		 | 12.000	  | Volts	   | ok    | na 	   | na 	   | na 	   | na 	   | na 	   | na
		PSU2_COut		 | 3.000	  | Amps	   | ok    | na 	   | na 	   | na 	   | na 	   | na 	   | na
		PSU2_POut		 | 36.000	  | Watts	   | ok    | na 	   | na 	   | na 	   | na 	   | na 	   | na
    */
...
int get_sensor_info_wbmc(int id, int *temp, int *warn, int *error, int *shutdown)
{
    ...
    char *Thermal_sensor_name[15] = {
        "Base_Temp_U5", "Base_Temp_U56", "Switch_Temp_U31", "Switch_Temp_U30",
        "Switch_Temp_U29", "Switch_Temp_U28","CPU_Temp","TEMP_DIMMA0",
		"TEMP_DIMMB0", "VDD_CORE_Temp","VDD_ANLG_Temp", 
...
int get_fan_speed_wbmc(int id,int *per, int *rpm)
{
    ...
    if (0 == strcmp(&strTmp[1][0], "na"))
        ...
        *per = (atof(&strTmp[1][0]) * 100 )/ CHASSIS_FAN_REAR_MAX_RPM;
